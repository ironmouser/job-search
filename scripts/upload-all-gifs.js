...
const GIF_FILES = ['thumbs.gif', 'lasso.gif', 'head.gif', 'fly.gif', 'lost.gif'];
...
async function uploadAllGifs() {
  ...
  console.log('All GIF uploads completed!');
}

uploadAllGifs().catch(err => {
  console.error('Error during GIF upload process:', err);
  process.exit(1);
});
