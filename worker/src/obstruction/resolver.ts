...
export class UIObstructionResolver {
  ...
  private static readonly COOKIE_REJECT_SELECTORS = [
    ...
    '[data-ui="cookie-banner-reject"]',
    '[data-ui*="cookie" i] [data-ui*="reject" i]',
    '[data-ui*="cookie" i] [data-ui*="decline" i]',
    'button[data-ui*="reject" i]',
    'button[data-ui*="decline" i]',
  ...
  private static readonly COOKIE_DISMISS_SELECTORS = [
    ...
    '[data-ui="cookie-banner-close"]',
    '[data-ui*="cookie" i] [data-ui*="close" i]',
    '[data-ui*="cookie" i] button[aria-label*="close" i]',
    '.w-cookie-banner button[aria-label*="close" i]',
    '[aria-label="Close" i]',
  ...
  private static readonly COOKIE_ACCEPT_FALLBACK_SELECTORS = [
    ...
    '[data-ui="cookie-banner-accept"]',
    '[data-ui*="cookie" i] [data-ui*="accept" i]',
    '[data-ui*="cookie" i] [data-ui*="agree" i]',
    'button[data-ui*="accept" i]',
    'button[data-ui*="agree" i]',
    '.w-cookie-banner button:has-text("Accept")',
    '.w-cookie-banner button:has-text("Allow")',
