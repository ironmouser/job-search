...
HUMAN WRITING REFERENCE EXAMPLES (Study these real, human-written cover letters for tone, structure, concrete metrics, and conversational enthusiasm. Adopt this exact human rhythm and confidence without ever using forbidden AI filler words or em-dashes):
...
During my time working as a Junior IT Project Manager at Connect, I was the second-in-charge to the Project Manager in leading a medium-sized development team. I was charged with the responsibility of helping oversee a range of critical projects from conception to delivery.
...
- Single-handedly launched an official TikTok account, accumulating 200,000+ followers
- Spearheaded 13 viral social media campaigns

I am competitive, up-to-date on all the latest trends, and can clean up the worst social media messes. I am positive my knack for creating clickable content is what your team is looking for.
...
I am enthusiastic about staying up-to-date with the latest trends and technologies in the digital marketing space, and Limitless's innovative approach to marketing is what inspired me to apply. I am confident my experience managing teams and collaborating with cross-functional stakeholders to achieve business objectives makes me an ideal candidate for the role.
...
- Developing a suite of AI-powered marketing tools specifically designed for small businesses, helping them automate and optimize their campaigns affordably
...
As a state-qualified registered nurse with 12 years of experience tending to patients, I am confident that I am the ideal candidate for your open nursing position at Mercy General.
...
I look forward to speaking to you about this position and discussing how my experiential care background aligns with Mercy General's dedication to patient support.
`;

export const NETWORKING_REFERENCE_EXAMPLES = `
HUMAN NETWORKING MESSAGE REFERENCE EXAMPLES (Study how these messages use natural conversational openings from human letters to build instant connection without cliché AI phrasing):
...
HUMAN Q&A REFERENCE EXAMPLES (Study how these human responses answer job application questions with crisp facts, engaging confidence, and concrete metrics without robotic fluff):

Q: Why are you interested in this role and what makes you a good candidate?
A: As a long-time admirer of your innovative approach, your recent initiatives aimed at empowering clients through cutting-edge techniques inspired me to apply. In my previous role at Bennett Solutions, I executed targeted data-driven campaigns that boosted online visibility and drove a 22% revenue increase in just six months. My combination of strategic team leadership and hands-on execution makes me confident I would be a high-impact asset to your ongoing growth plans.

Q: Describe your biggest professional achievement and its impact on the business.
A: While serving as an IT Project Manager at Connect, I was tasked with leading a medium-sized development team on a mission-critical $500,000 digital transformation initiative. By refining our Q&A testing, integration workflows, and user documentation, my team successfully delivered the project ahead of schedule while reducing our rate of production incidents by 5%. This success paved the way for us to secure and manage several additional profitable client accounts with budgets exceeding $200,000.

Q: How do you handle high-stress situations or fast-paced environments?
A: As a state-qualified registered nurse evaluating over 24 patients daily, thriving in fast-paced, high-stakes environments is second nature to me. Whether responding immediately to emergency medical situations or developing complex personalized care plans on the fly, I maintain clear communication with colleagues and provide sympathetic support to families. Staying calm, organized, and collaborative under pressure ensures safe and highly effective patient care.
`;
