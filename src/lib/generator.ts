...
4. NO CLICHÉ AI FILLER, ROBOTIC FLUFF, OR RAMBLING WORD SALAD (CRITICAL):
   - NO DRAMATIC PREAMBLE OR STORYTELLING HOOKS: NEVER open with a hypothetical scenario or dramatic monologue (e.g. do NOT write "A safe contractor waiting weeks...", "Picture an engineer struggling...", or philosophical industry musings).
   ...
   - PREFERRED DIRECT OPENINGS: State the exact role and company clearly, connecting your highest-level qualification and the company's core focus in 2-3 crisp, conversational sentences (e.g. "I am applying for the [Role] position at [Company]. With [X] years of experience building [systems/products], I specialize in [turning operational bottlenecks into reliable software that teams trust].", or "[Company]'s mission to [mission] connects with my experience leading [domain]...").
...
2. COVER LETTER STRUCTURE: Split into exactly three short paragraphs:
   - Paragraph 1 (2-3 sentences max): Direct, punchy application stating the exact role and company, your highest-level qualification/years of experience, and how your core strengths connect with their product focus. Start directly without fictional scenarios or rambling setup.
   - Paragraph 2: Narrative business and user impact. Do NOT just list resume items or say what you did (e.g. "At Company A I did X, and at Company B I did Y"). Instead, make the focus WHY what you did was important and HOW it benefited the company and/or users (e.g. solving core operational bottlenecks, eliminating friction, driving customer retention, or unblocking growth), connecting those proven outcomes directly to the challenges in the job description.
   - Paragraph 3: Direct, polished call to action for an interview.
3. BALANCED HYPHEN USE & NO BUZZWORD STACKING (CRITICAL):
   - NO DASHES AS PUNCTUATION: Do NOT use em-dashes ("—" or "--") or hyphens ("-") as punctuation between clauses. Use commas, periods, or natural sentence transitions instead.
   - ALLOWED ENTERPRISE TERMS: Standard industry expressions like "customer-centric" and "cross-functional" are fully allowed and encouraged! Use them where natural and appropriate.
   - AVOID HYPHEN OVERUSE & BUZZWORD STACKING: Using hyphens occasionally is natural, but chaining multiple hyphenated compound modifiers in the same sentence draws attention as AI-generated text. Do not over-rely on repeating formulas like "AI-enabled," "results-oriented," or "high-impact" in every bullet point. Vary your phrasing. Keep the rhythm conversational, natural, and authentically human.
4. NO CLICHÉ AI FILLER, ROBOTIC FLUFF, OR RAMBLING WORD SALAD (CRITICAL):
   - NO DRAMATIC PREAMBLE OR STORYTELLING HOOKS: NEVER open with a hypothetical scenario or dramatic monologue (e.g. do NOT write "A safe contractor waiting weeks...", "Picture an engineer struggling...", or philosophical industry musings).
   - FORBIDDEN OPENINGS: NEVER write "deeply resonates with", "resonates with my own experience", "I'm applying because ... resonates", "I am thrilled/excited to apply because", or "inspired me to apply".
   - PREFERRED DIRECT OPENINGS: State the exact role and company clearly, connecting your highest-level qualification and the company's core focus in 2-3 crisp, conversational sentences (e.g. "I am applying for the [Role] position at [Company]. With [X] years of experience building [systems/products], I specialize in [turning operational bottlenecks into reliable software that teams trust].", or "[Company]'s mission to [mission] connects with my experience leading [domain]...").
