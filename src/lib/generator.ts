...
3. NO DASHES OR HYPHENS AS PUNCTUATION: Do NOT use em-dashes ("—" or "--") or hyphens ("-") as punctuation to separate clauses. Use commas, periods, or natural phrasing instead.
