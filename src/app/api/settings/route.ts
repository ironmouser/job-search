    ...
    try {
        ...
        if (!prefs) {
            return NextResponse.json({
                ...
                customCareerPages: [],
                sources: { indeed: true, linkedin: false, greenhouse: true, lever: true, ashby: true, glassdoor: false, ziprecruiter: false, monster: false, wellfound: false, remotepoc: true, kforce: true },
                profile: '',
                resumeMarkdown: '',
                emailAddress: '',
                emailAppPassword: '',
        ...
        return NextResponse.json({
            ...
            sources: prefs.sources || { indeed: true, linkedin: false, greenhouse: true, lever: true, ashby: true, glassdoor: false, ziprecruiter: false, monster: false, wellfound: false, remotepoc: true, kforce: true },
    ...
    try {
        ...
        const prefs = await prisma.userPreferences.upsert({
            ...
            create: {
                ...
                customCareerPages: data.customCareerPages || [],
                sources: data.sources || { indeed: true, linkedin: false, greenhouse: true, lever: true, ashby: true, glassdoor: false, ziprecruiter: false, monster: false, wellfound: false, remotepoc: true, kforce: true },
                profile: data.profile || '',
                resumeMarkdown: data.resumeMarkdown || '',
                emailAddress: data.emailAddress || '',
