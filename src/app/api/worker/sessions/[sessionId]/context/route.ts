  ...
  try {
    ...
    const payload = {
      ...
      userProfile: {
        ...
        streetAddress: (prefs as any)?.streetAddress || (prefs?.sources as any)?.customAnswers?.['streetAddress'] || (prefs?.sources as any)?.customAnswers?.['addressLine1'] || (prefs?.sources as any)?.customAnswers?.['Address Line 1'] || undefined,
        city: (prefs as any)?.city || (prefs?.sources as any)?.customAnswers?.['city'] || (prefs?.sources as any)?.customAnswers?.['City'] || (prefs?.location ? prefs.location.split(',')[0]?.trim() : undefined) || undefined,
        state: (prefs as any)?.state || (prefs?.sources as any)?.customAnswers?.['state'] || (prefs?.sources as any)?.customAnswers?.['State'] || (prefs?.location ? prefs.location.split(',')[1]?.trim() : undefined) || undefined,
